...
\usepackage{titling}
\title{Entwicklung eines framework-agnostischen Verfahrens zur Optimierung von Testläufen durch Wiederverwendung von Testergebnissen}
\author{Ruben Leander Rosenmeyer}
...
\begin{document}
    ...
    \pagestyle{scrheadings} % remove chapter name from top, page number at the bottom
    ...
    \input{chapters/0_3-ressources.tex}
    \input{chapters/0_2-summary.tex}
