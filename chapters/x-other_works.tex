...
Eine weitere Gemeinsamkeit besteht in der Wichtigkeit von reproduzierbaren Entwicklungsumgebungen: Beim Build Caching müssen die Entwicklungsumgebungen von zwei Build-Läufen identisch sein, um die Artefakte des vorherigen Laufs übernehmen zu können. Beim hier entwickelten Verfahren ist eine identische Entwicklungsumgebung sogar eine Voraussetzung, um die Aussagekraft des Verfahrens durch die Verwendung von Ergebnissen aus einem vorherigen Lauf nicht einzuschränken. (vgl. \textcite[6-8]{zhengBC})
