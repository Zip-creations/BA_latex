...
\begin{lstlisting}[caption={Minimales TAP-Beispiel}, label={TAPmin}]
    ...
    ok
\end{lstlisting}
Solch eine Darstellung ist natürlich ungeeignet, da keine Zuordnung zwischen Testergebnis und Testcase möglich ist. In der Praxis kann dieser Zusammenhang allerdings durch die optionalen Zusatzinformationen gesesetzt werden, wie beispielhaft in \lstref{TAPpy} demonstriert:
...
\begin{lstlisting}[caption={TAP, erzeugt durch catch2.\\ \textellipsis{} bezeichnet gekürzte Stellen.}, label={TAPcatch2}]
    ...
    ...
\end{lstlisting}
was TAP in diesem Falle als Ausgabeformat ungeeignet macht. Andere Testframeworks wie bespielsweise pytest oder tasty sorgen allerdings für eine eindeutige Zuordnung in ihren jeweiligen Ausgaben. 
