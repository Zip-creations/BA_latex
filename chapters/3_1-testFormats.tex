...
\begin{itemize}
    ...
    \item \textbf{test\_skip:} Ein Testcase, der übersprungen wird. Manche Testframeworks untrscheiden zwischen übersprungenen, und ignorierten Tests: Übersprungene Tests werden nicht ausgeführt, aber als übersrungen in der Testausgabe markiert, ignorierte Tests werden werder ausgeführt, noch in die Testausgabe übernommen. Letzteres ist für die Evaluation der Testausgabeformate uninteressant. 
...
\end{itemize}
In der zweiten Datei liegt ein Testcase m Namespace \textbf{BasicTest2}:
\begin{itemize}
