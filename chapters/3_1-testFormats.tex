...
\begin{lstlisting}[caption={Minimales TAP-Beispiel}, label={TAPmin}]
    ...
    ok
\end{lstlisting}
Solch eine Darstellung ist natürlich ungeeignet, da keine Zuordnung zwischen Testergebnis und Testcase möglich ist. In der Praxis kann dieser Zusammenhang allerdings durch die optionalen Zusatzinformationen gesesetzt werden, wie beispielhaft mit pytest in \lstref{TAPpy} demonstriert:
