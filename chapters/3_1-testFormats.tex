...
<testsuites name="default">
    <testsuite name="Basic tests" file=
        "features/basic.feature" tests="4" skipped="0"
        failures="2" errors="0" time="0.006">
        <testcase name="test_neg" classname="Basic tests"
            status="passed" time="0.004"
            file="features/basic.feature" line="4"></testcase>
    ...
\end{lstlisting}
...
junit5 (maven), Java:
<testcase name="test_neg" classname="BasicTest"
    time="0.012"/>
phpunit, PHP:
<testcase name="test_neg" file="/home/.../test.php"
    line="7" class="BasicTest" classname="BasicTest"
    assertions="1" time="0.000645"/>
gtest, C++:
<testcase name="test_neg" file="./test/gtest/test.cpp"
    line="3" status="run" result="completed" time="0."
    timestamp="2026-06-23T22:50:35.285" classname="BasicTests" />
\end{lstlisting}
...
Aus \lstref{JUNITcompare} ist ersichtlich, dass sich die benutzten Attribute des <testcase>-tags sowie deren Inhalt stark unterscheiden können, jedoch werden für zwei Attribute für gewöhnlich gesetzt, und in gleicher Weise verwendet:
\begin{itemize}
    \item name="" enthält den namen des Testcase
    \item classname="" enthält den namespace bzw. die Klasse des Testcase
\end{itemize}
Dieser Trend aus \lstref{JUNITcompare} setzt sich auch in den übrigen im Datensatz untersuchten JUnit XML Ausgaben fort. Es gibt zwar einige wenige Ausnahmen wie exemplarisch in \lstref{JUNITcodeception} dargestellt, diese sind jedoch eher selten.
...
Tabelle mit wo Zuordnung möglich
...
TAP ist aufgrund seiner sehr geringer Minimalstruktur und vor allem seiner nur mäßigen Verbreitung eher nicht als Testausgabeformat für das Tool geeignet.
