...
<testcase name="test_neg" file="./test/gtest/test.cpp" line="3" status="run" result="completed" time="0." timestamp="2026-06-23T22:50:35.285" classname="BasicTests" />
\end{lstlisting}
...
\makebox[\textwidth][c]{
    \begin{tabular}{|c|c||c|c|}
        ...
        name+classname} & \makecell{andere Zuordnung}\\
        \hline
        \hline
        catch2 & C++ &  & \\
        \hline
    ...
    \begin{tabular}{ll}
        ...
        \tabUnused & nicht benötigt\\
        \tabNo & Zuordnung nicht eindeutig möglich\\
    \end{tabular}
    \caption{Übersicht der Verbreitung bestimmter Formate}
    \label{Formatvergleich}
