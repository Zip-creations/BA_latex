...
\begin{itemize}
    \item \texttt{test\_neg():} Ein einfacher Testcase, der eine korrekte Assertion beinhaltet und nicht fehlschlägt.
    \item \texttt{test\_pos():} Ein einfacher Testcase, der eine falsche Assertion beinhaltet und fehlschlägt.
    \item \texttt{test\_skip():} Ein Testcase, der übersprungen wird. Manche Testframeworks unterscheiden zwischen übersprungenen, und ignorierten Testcases: Übersprungene Testcases werden nicht ausgeführt, aber als übersprungen in der Testausgabe markiert. Ignorierte Testcases werden werder ausgeführt, noch in die Testausgabe übernommen. Dies macht ignorierte Testcases für die Evaluation der Testausgabeformate uninteressant. 
...
\end{itemize}
\texttt{test\_same\_name} untersucht, ob es allein aus der Testausgabe heraus möglich ist, einen Testcase eindeutig zu indentifizieren, auch wenn in unterschiedlichen Namespaces verschiedene Testcases den selben Namen aufweisen.
...
\subsubsection{Evaluation der Anforderungen nach \chapref{Anforderungen Testausgabeformat}}\label{Evaluation_Junit}
\begin{table}[htbp]
    \centering
    \makebox[\textwidth][c]{
    \begin{tabular}{|c|c|}
...
\subsubsection{Evaluation der Anforderungen nach \chapref{Anforderungen Testausgabeformat}}\label{Evaluation_TAP}
\begin{table}[htbp]
    \centering
    \makebox[\textwidth][c]{
    \begin{tabular}{|c|c|}
        ...
        \makecell{sagt für jeden Testcase einzelnd aus,\\ ob er ausgeführt wurde oder nicht} & \tabPartial \\
        \hline
        strukturiertes Format & \tabYes \\
        \hline
        weite Verbreitung & \tabPartial \\
        \hline
    \end{tabular}
    }
    \begin{tabular}{ll}
...
\subsubsection{Evaluation der Anforderungen nach \chapref{Anforderungen Testausgabeformat}}\label{Evaluation_OTR}
\begin{table}[htbp]
    \centering
    \makebox[\textwidth][c]{
    \begin{tabular}{|c|c|}
