...
\begin{itemize}
      ...
      \item Zahl der vom Verfahren ausgeführten Testcases
...
beginnt mit der Analyse der Anforderungen, die ausgehend von \chapref{Zielsetzung} an das Verfahren gestellt werden. Daraus werden die Anforderungen an ein Testausgabeformat abgeleitet. Anschließend werden die Grundlagen reproduzierbarer  Builds und der Entstehung von Testausgabeformaten beleuchtet, die für das Verständnis der folgenden Kapitel erforderlich sind.
