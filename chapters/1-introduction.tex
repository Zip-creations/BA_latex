...
beginnt mit der Analyse der Anforderungen, die ausgehend von \chapref{Zielsetzung} an das Verfahren gestellt werden. Daraus werden die Anforderungen an ein Testausgabeformat abgeleitet. Anschließend werden die Konzepte von deterministischen Builds und der Entstehung von Testausgabeformaten beleuchtet, deren Mechaniken in zum Veständnis der späteren Kapitel benötigt werden.

\textbf{\chapref{Vergleich Testausgabefomate}: Vergleich von Testausgabeformaten}
beschäftigt sich mit der Lösung der Frage, welches Testausgabeformat für das Verfahren als Input in Frage kommt, um den in \chapref{Anforderungen Tool} gestellten Anforderungen gerecht zu werden. Dazu wird in diesem Kapitel zunächst anhand des Datensatzes untersucht, welche Testausgabeformate wieweit verbreitet sind. Anschließend werden die verbreitesten Formate genauer analysiert, und auf ihre Eignung für das Verfahren untersucht. Das Kapitel endet mit einer stichhaltig begründeteten Entscheidung für ein Format.


In \textbf{\chapref{chap:approach}: Konzeptionierung und Umsetzung}
wird das Verfahren unter Berücksichtigung der Konsequenzen aus \chapref{Vergleich Testausgabefomate} konzeptionell erläutert. Die einzelnen Komponenten des Verfahrens sowie ihr Zusammenspiel werden im Detail erklärt. Anschließend werden die daraus resultierenden Anforderungen erfasst, die an ein Testausgabeformat und ein Projekt, in welches das Verfahren integriert werden kann gestellt werden.  


\textbf{\chapref{chap:conclusion}: Analyse der Laufzeit}
präsentiert die Ergebnise der Benchmark, und anaylsiert anhand dieser das Laufzeitverhalten des Verfahrens in einem Projekt


\textbf{\chapref{Fazit}: Fazit}
schließt diese Bachelorarbeit mit einer Zusammenfassung der Ergebnisse, der Analyse, in wieweit das Verfahren die eingangs gestellten Anforderungen erfüllen konnte, und einer Analyse über mögliche Verbesserungen des Verfahrens. 
