...
\begin{itemize}
    ...
    Dieser Punkt ist essenziell, zum einen damit \texttt{testAuditor} eine Aussage darüber treffen kann, ob eine vollständige Abddeckung aller Testcases erzielt wurde, zum anderen muss \texttt{testAuditor} zum Erzielen einer vollständigen Abdeckung potentiell auf jeden vorhandenen Testcase zugreifen können. Dazu muss \texttt{testAuditor} selbstverständlich auch jeder Testcase innerhalb des Projektes bekannt sein.
...
Ein vollständige Garantie des Determinismus zwischen Systemen ist nur schwer zu erreichen, jedoch bietet \texttt{Nix} hier eine ausreichende Grundlage. 

\section{Entstehung eines Testausgabeformats}
Um zu Verdeutlichen, wie die finale Form Testausgabeformates entsteht, wird in diesem Kapitel näher auf die Faktoren eingegangen, welche die genaue Struktur und das finale Aussehen des Testausgabeformates beeinflussen.
...
\begin{itemize}
  ...
  Das verwendete Testframework ist für gewöhnlich an jedem Schritt der Testgenerierung beteiligt und erfült die Rolle eines managers der einzelnen Komponenten. Daher bestimmt es je nach konkretem Framework stärker oder schwächer die Verwednung der folgenden Punkte:
