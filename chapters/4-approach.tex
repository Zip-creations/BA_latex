...
In diesem Kapitel werden die einzelnen Komponenten des Verfahrens, so wie ihr Zusammenspiel untereinander im Detail erläutert.
...
\end{lstlisting}
Der Inhalt der beiden tags ''classname'' und ''name'' für einen Testcase muss dabei zwingend identisch mit dem Inhalt der beiden tags in der JUnit-XML Ausgabe des Testcase sein, da in einem späterem Schritt über die Kombination dieser beiden tags die Testcases eindeutig identifiziert werden.\\
...
\input{figures/tool_script_interaction.tex}
