...
\begin{lstlisting}[caption={direkter Vergleich von Junit XML, erzeugt durch Junit5 mit Jupiter in Java. Jeder Ausgabe liegen die selben Testdateien zu Grunde.}, label={JAVACompare}]
